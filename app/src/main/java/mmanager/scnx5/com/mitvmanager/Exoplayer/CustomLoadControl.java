...
public final class CustomLoadControl implements LoadControl {
    ...
    public boolean shouldContinueLoading(long bufferedDurationUs, float playbackSpeed) {
        final long bdUs=bufferedDurationUs;
        ...
        if (null != bufferedDurationListener && null != eventHandler)
            eventHandler.post(new Runnable() {
                @Override
                public void run() {
                    bufferedDurationListener.onBufferedDurationSample(bdUs);
                }
            });

        Log.d("CustomLoadControl","current buff Dur: "+bufferedDurationUs+",max buff:" + maxBufferUs +" shouldContinueLoading: "+isBuffering);
