...
*/
        ...
        SearchLiveTv.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                ...
                myAdapter = new RecyclerViewAdapter(vod_grid_activity.this,FilterChannel);
...
*/
    ...
    private class FilterContent extends AsyncTask<Integer, Integer, String>
    {
        ...
        protected void onPostExecute(String result) {
            ...
            myAdapter = new RecyclerViewAdapter(vod_grid_activity.this,NewVOD);
            myrv.setAdapter(myAdapter);
    ...
    private class LoadVODInBookList extends AsyncTask<String,String,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            getURL wget=new getURL();
            String json= wget.getURL("https://layar3.com/apps/vod/getvodlist.php");
            ...
            myrv = (RecyclerView) findViewById(R.id.recyclerview_id);
            myAdapter = new RecyclerViewAdapter(vod_grid_activity.this,VOD);
