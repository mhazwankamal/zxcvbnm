...
public class RecyclerViewAdapterHomeLastWatch extends RecyclerView.Adapter<RecyclerViewAdapterHomeLastWatch.MyViewHolderRB> {
    ...
    public RecyclerViewAdapterHomeLastWatch(Context mContext, List<HomeTrendBook> mData,String server,String tk,String Json) {
    ...
    @Override
    public RecyclerViewAdapterHomeLastWatch.MyViewHolderRB onCreateViewHolder(ViewGroup parent, int viewType) {
       ...
       /* double width = Resources.getSystem().getDisplayMetrics().widthPixels;
        ...
        return new RecyclerViewAdapterHomeLastWatch.MyViewHolderRB(view);
    }

    @Override
    public void onBindViewHolder(RecyclerViewAdapterHomeLastWatch.MyViewHolderRB holder, final int position) {
        ...
        String focus_last = pref.getString("last_watch", null);
