...
public class RecyclerViewAdapterHomeTrend extends RecyclerView.Adapter<RecyclerViewAdapterHomeTrend.MyViewHolderRB> {
    ...
    public RecyclerViewAdapterHomeTrend(Context mContext, List<HomeTrendBook> mData,String server,String tk,String Json) {
    ...
    @Override
    public RecyclerViewAdapterHomeTrend.MyViewHolderRB onCreateViewHolder(ViewGroup parent, int viewType) {
       ...
       /* double width = Resources.getSystem().getDisplayMetrics().widthPixels;
        ...
        view = mInflater.inflate(R.layout.home_trending_channel, parent, false);


        return new RecyclerViewAdapterHomeTrend.MyViewHolderRB(view);
    }

    @Override
    public void onBindViewHolder(RecyclerViewAdapterHomeTrend.MyViewHolderRB holder, final int position) {
        ...
        String focus_last = pref.getString("trending", null);
